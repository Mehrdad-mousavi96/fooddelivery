...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      {/* Card Button */}
      <button className="bg-black text-white hidden md:flex flex items-center justify-center py-2 rounded-full">
      ...
      {/* Overlay */}
      {nav ? (
        <div className="bg-black/80 fixed w-full h-screen z-10 left-0 top-0 right-0"></div>
      ) : (
        ""
      )}
